...
def train_model(adata, gene_dims, img_dims, proj_dims, lamb1=0.3, lamb2=0.1, lamb3=1, gamma=0.2, pre_epoch=1500,
                cont_epoch=50, pc_dims=32, adj_key='mor_adj', device='cpu'):
